...
random_namber = Math.floor(Math.random() * quick_draw_data_set.length + 1);
console.log(random_namber);
sketch = quick_draw_data_set[random_namber];
console.log(sketch);
...
function preload(){
    ...
    score_sound = new Audio("score-sound.wav");
}
